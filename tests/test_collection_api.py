    ...
    def test_local_api_returns_snapshot_and_status(self):
        ...
        with self.subTest("database"):
            with tempfile.TemporaryDirectory() as directory:
                ...
                worker._write_product_action(conn, "api-test", conn.execute("SELECT * FROM item_state").fetchone(), data, body, 200, None, raw_html_dir=root / "raw", context={"postal_code": "90001", "expected_country": "US", "expected_currency": "USD"})
                conn.close()
