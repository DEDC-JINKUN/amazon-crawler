...
def test_discover_deduplicates_amazon_candidates_and_excludes_foreign_links():
    with tempfile.TemporaryDirectory() as directory:
        ...
        source.write_text('<div data-asin="B00RCPDCQU"></div><a href="/dp/B00RCPDCQU">one</a><a href="https://www.amazon.com/gp/product/B00RCPDCQU">duplicate</a><a href="/dp/B00RCPDI50?x=1">two</a><a data-asin="B00RCPDI50"></a><a href="https://example.com/dp/B00RCPDKDA">no</a>', encoding="utf-8")
